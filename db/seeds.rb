...
destination4 = Destination.create(name: "Prysm", date_visited: "07/14/2019", address: "5678 Party Ave", category: "Club/Bar", comment: "Jack told me it was lit when he went there last time.", visited: false, cost: 0, attendees: "", user_id: user1.id)
